...
void clrScr(void)
{
    ...
    fillRect(0, 0, DISP_X_SIZE, DISP_Y_SIZE, 147, 139, 161);
}

void clrArrow(void) {
	setColor(147, 139, 161);
	fillRect(15,110, 31, 216, 147, 139, 161);
...
void drawMenu(int x, int y, int w, int h) {
	clrScr();
	printText("Menu", 88, 50, 1);
	printText("Tuner", 80, 110, 1);
	printText("A4 Value", 56, 140, 1);
	printText("Octave", 72, 170, 1);
	printText("Histogram", 48, 200, 1);
}
...
void printText(char *st, int x, int y, int bigFont) {
	setColor(255, 255, 255);
	setXY(x-20, y-5, x+6*cfont.x_size+20, y+cfont.y_size+5);
//	fillRect(x-5, y-5, x+6*cfont.x_size+5, y+cfont.y_size+5);
